...
const createconfirmationURL = (userdId) => __awaiter(void 0, void 0, void 0, function* () {
    const token = uuid_1.v4();
    yield redis_1.redis.set(redisPrefixes_1.confirmationPrefix + token, userdId, "ex", 60 * 60 * 24);
